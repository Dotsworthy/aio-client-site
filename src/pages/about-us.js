...
import downloadFile from "../images/AIO Mission Statement.pdf";
    ...
    return (
        <Layout siteType={"client"}>
            ...
            <div className="banner-container">
                <StaticImage className="banner-image" src="../images/79574096_m.jpg" alt="about us" />
            ...
            <div className="content-box" id="blue">
                ...
                <div className="content-box-horizontal">
                    <div className="profile-box" id="white">
                        ...
                        <img className="employee-picture" src={annaMayhew} alt="Anna Mayhew" id="img-1" />
                    ...
                    >
                        ...
                        <img className="employee-picture" src={ginaLorenzetti} alt="Gina Lorenzetti" id="img-3" />
                    ...
                    <div className="profile-box" id="white">
                        ...
                        <img className="employee-picture" src={nikhatYusaf} alt="Nikhat Yusaf" id="img-4" />
                    ...
                    <div className="profile-box" id="white">
                        ...
                        <img className="employee-picture" src={henryLampitt} alt="Henry Lampitt" id="img-5" />
                    ...
                    <div className="profile-box" id="white">
                        ...
                        <img className="employee-picture" src={christinePont} alt="Christine Pont" id="img-6" />
                    ...
                    >
                        ...
                        <img className="employee-picture" src={lizzieRiungu} alt="Lizzie Riungu" id="img-7" />
