            ...
            <div className="content-box" id="blue">
                ...
                <div className="content-box-horizontal">
                    ...
                    >
                        ...
                        <StaticImage className="employee-picture" src="../images/anna-mayhew.jpg" alt="inclusive" id="img-1"/>
                    ...
                    >
                        ...
                        <StaticImage className="employee-picture" src="../images/zo-daniels.png" alt="inclusive" id="img-2"/>
                    ...
                    >
                        ...
                        <StaticImage className="employee-picture" src="../images/gina-lorenzetti.png" alt="inclusive" id="img-3"/>
                    ...
                    >
                        ...
                        <StaticImage className="employee-picture" src="../images/nikhat-yusef.png" alt="inclusive" id="img-4"/>
                    ...
                    >
                        ...
                        <StaticImage className="employee-picture" src="../images/henry-lampitt.png" alt="inclusive" id="img-5"/>
                    ...
                    >
                        ...
                        <StaticImage className="employee-picture" src="../images/christine-pont.png" alt="inclusive" id="img-6"/>
                    ...
                    >
                        ...
                        <StaticImage className="employee-picture" src="../images/lizzie-riungu.png" alt="inclusive" id="img-7"/>
